							...
							<?php
								if(!$blog){
									foreach( $category_name as $val){
										echo "<li><h2 class='category-title'>".$val[0]['category_name']."</h2></li>";
									}
								}
							?>
  							<?php
  ...
  <div id="right-column">
      ...
      <div class="links-multi">
        ...
        <ul class="clean">
          ...
          ?>
          <li > <a href="#"  > January <span>(5)</span></a></li>
          <li > <a href="#"  > Feabuary <span>(1)</span></a></li>
        </ul>
      </div>
    <?php } ?>
      <div class="links-multi category">
