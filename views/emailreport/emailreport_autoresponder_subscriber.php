...
<div id="body-dashborad" class="nobackground">
  <div class="container">
    ...
    <div class="left-menu contacts stats">
      <div class="editing-theme-box <?php echo $current_tab == 'send_email' ? 'active' : '';?>" onclick="window.location='<?php echo  site_url("newsletter/emailreport_autoresponder/view/sent/$campaign_id/$scheduled_id");?>'">
                ...
                <tr>
                  <td>
                    <?php if($campaign_data['is_restore']==1){
                      ...
                      <a class="view_subscriber" href="<?php echo site_url('newsletter/emailreport_autoresponder/subscriber_view/'.$campaign_id.'/'.$subscriber['email_track_subscriber_id'].'/'.$subscriber['autoresponder_scheduled_id']); ?>"><?php echo $subscriber['subscriber_email_address']; ?></a>
                    <?php } ?>
                  </td>
                  <td>
                ...
                <?php }else if(isset($emailreport_subsciber_data)){
                  if(count($emailreport_subsciber_data)>0){
                    foreach($emailreport_subsciber_data as $subscriber){ ?>
                      <tr>
                        <td><a href="<?php echo site_url('newsletter/emailreport_autoresponder/subscriber_view/'.$subscriber['campaign_id'].'/'.$subscriber['subscriber_id']); ?>"><?php echo $subscriber['subscriber_email_address']; ?></a></td>
                            ...
                            <tr>
                              <td>
                                <?php if($campaign_data['is_restore']==0){?>
                                  <a href="<?php echo site_url('newsletter/emailreport_autoresponder/subscriber_view/'.$subscriber['campaign_id'].'/'.$subscriber['subscriber_id']); ?>">
                                <?php } ?>
