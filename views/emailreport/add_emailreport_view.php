...
function submit_form(){
	...
	<?php if($autoresponder==1){?>
		url="<?php echo base_url() ?>newsletter/contacts/add_autoresponder_emailreport_to_contact_list/<?php echo $action; ?>/<?php echo $campaign_id; ?>/<?php echo $scheduled_id; ?>";
	<?php }else{ ?>
		url="<?php echo base_url() ?>newsletter/contacts/add_emailreport_to_contact_list/<?php echo $action; ?>/<?php echo $campaign_id; ?>/<?php echo $tinyUrl; ?>";
	<?php } ?>
	jQuery.ajax({
		url: url,
		type:"POST",
