  ...
  <div id="body-dashborad">
    <div class="container">
      <div class="dashboard-home">
       ...
       <?php
			echo form_open('newsletter/campaign/email_setting/'.$campaign_data['campaigns']['campaign_id'], array('id' => 'form_campaign_send','name'=>'form_campaign_send','class'=>"form-website"));
	 ?>

       <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="32%" class="label">Campaign</td>
    <td width="68%">
	<?php echo ucwords($campaign_data['campaigns']['campaign_title']); ?>
	</td>
  </tr>
  <tr>
    <td height="15" ></td>
