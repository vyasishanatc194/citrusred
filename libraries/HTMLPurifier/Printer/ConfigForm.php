...
class HTMLPurifier_Printer_ConfigForm extends HTMLPurifier_Printer
{
    ...
    public static function getCSS() {
        return file_get_contents(HTMLPURIFIER_PREFIX . '/HTMLPurifier/Printer/ConfigForm.css?v=6-20-13');
    }
    ...
    public static function getJavaScript() {
        return file_get_contents(HTMLPURIFIER_PREFIX . '/HTMLPurifier/Printer/ConfigForm.js?v=6-20-13');
    }
