<?php
class Api_information extends CI_Controller
{
  ...
  function index()
  {
    ...
    $this->load->view('header_outer',array('seo_array'=>$seo_array,'title'=>'API Information - RedCappi Email Marketing','show_bottom_bar'=>true));
    $this->load->view('api_information');
