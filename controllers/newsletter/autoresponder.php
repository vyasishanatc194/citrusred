		...
		if(count($autoresponder_data['autoresponders'])) {
			...
			foreach($autoresponder_data['autoresponders'] as $autoresponder){
				...
				if($autoresponder['campaign_status']){
					$msg_status= '<img class="auto_pause campion_send" src="'.$this->config->item('webappassets').'images/new_png_design/Pause-Icon.png?v=6-20-13" alt="campaigns"/><img class="auto_play campion_send" src="'.$this->config->item('webappassets').'images/new_png_design/play.png?v=6-20-13" alt="campaigns" style="display: none"/>';
					$campaign_status = '';
				}else{
					$msg_status= '<img class="auto_play campion_send" src="'.$this->config->item('webappassets').'images/new_png_design/play.png?v=6-20-13" alt="campaigns"/><img class="auto_pause campion_send" src="'.$this->config->item('webappassets').'images/new_png_design/Pause-Icon.png?v=6-20-13" alt="campaigns" style="display: none"/>';
				...
				if($autoresponder['autoresponder_scheduled_id']==0){
					...
					if($autoresponder['autoresponder_scheduled_interval']==0){
						$day='<small>Send <strong class="day"> within a couple hours after</strong> signup</small><br/><a class="fancybox_edit_inerval edit-interval" href="javascript:void(0);">Edit</a><span class="hide_autoresponder_id" style="display:none;">'.$autoresponder['campaign_id'].'</span>';
				...
				if($autoresponder['campaign_template_option']==3){
					$edit='<a class="btn cancel" href="'.site_url('newsletter/autoresponder/autoresponder_editor/'.$autoresponder['campaign_id']).'"><img class="campion_send" src="'.$this->config->item('webappassets').'images/new_png_design/Email-Icon-Edit.png?v=6-20-13" alt="campaigns"></a>';
				}else{
					$edit='<a class="btn cancel" href="'.site_url('newsletter/campaign_template_options/autoresponder/'.$autoresponder['campaign_id']).'"><img class="campion_send" src="'.$this->config->item('webappassets').'images/new_png_design/Email-Icon-Edit.png?v=6-20-13" alt="campaigns"></a>';
				}
				...
				<li>'.$edit.'</li>
				<li><a href="'. site_url('newsletter/autoresponder/copy_archived/'.$autoresponder['campaign_id']).'" class="btn cancel"><img class="campion_send" src="'.$this->config->item('webappassets').'images/new_png_design/Email-Icon-Copy.png?v=6-20-13" alt="campaigns"></a></li>
				<li><a target="_blank" href="'.$autoresponder_preview_link.'" rel="facebox" class="btn cancel"><img class="campion_send" src="'.$this->config->item('webappassets').'images/new_png_design/Email-Icon-Preview.png?v=6-20-13" alt="campaigns"></a></li>
				<li><a  '.$stats_url.' class="btn cancel"><img class="campion_send" src="'.$this->config->item('webappassets').'images/new_png_design/Menu-Icon-Stats.png?v=6-20-13" alt="campaigns"></a></li>
				<li ><a class="delete-row btn cancel" name="'.$autoresponder['campaign_id'].'" href="javascript:void(0);"><img class="campion_send" src="'.$this->config->item('webappassets').'images/new_png_design/Email-Icon-Trash.png?v=6-20-13" alt="campaigns"></a></li>
				</ul>
				</td>
				</tr>';
				$i++;
