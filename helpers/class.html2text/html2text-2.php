...
$html2text_elements['script'] = Array(false,false,true,0,0,false,'','',false,false,false);
$html2text_elements['style'] = Array(false,false,true,0,0,false,'','',false,false,false);
...
function html2text( $sourceStr, $isXML = false, $isfile = false ) {
    ...
    if( is_object($sourceStr) ) {
        ...
        if( $isXML ) {
            ...
            $strippedStr = preg_replace( "/<\?[\w\W]*\?>/", '', $sourceStr );
            if( $strippedStr === null ) {
