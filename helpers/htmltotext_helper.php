...
# Array( isFlow, isPreformatted, isVoid, marginTop, marginBottom, dropFirstChildMargin, before, after, isBeforeFunction, isAfterFunction, dropOnFirst );
...
$html2text_elements['unknown element'] = Array(false,false,false,0,0,true,'','',false,false,false); //used for all unknown or default elements
$html2text_elements['html'] = Array(true,false,false,10,10,true,'','',false,false,false);
$html2text_elements['title'] = Array(true,false,true,1,1,true,'','',false,false,false);
$html2text_elements['script'] =
$html2text_elements['style'] =
$html2text_elements['datalist'] = Array(false,false,true,0,0,true,'','',false,false,false);
$html2text_elements['h1'] = Array(true,false,false,1,1,false,'** ',' **',false,false,false);
$html2text_elements['h2'] = Array(true,false,false,1,1,false,'*','*',false,false,false);
$html2text_elements['h3'] = Array(true,false,false,1,1,false,'-','-',false,false,false);
...
$html2text_elements['span'] = Array(true,false,false,0,0,false,'','',false,false,false);
...
$html2text_elements['header'] = Array(false,false,false,1,1,false,'','',false,false,false);
$html2text_elements['dt'] = Array(true,false,false,1,1,false,'* ','',false,false,false); 
$html2text_elements['th'] =
$html2text_elements['td'] = Array(true,false,false,2,2,true,"","\n",false,false,true);
...
$html2text_elements['del'] = Array(false,false,false,0,0,true,'[DEL: ',' :DEL]',false,false,false);
$html2text_elements['ins'] = Array(false,false,false,0,0,true,'[INS: ',' :INS]',false,false,false);
$html2text_elements['strong'] =
$html2text_elements['b'] =
$html2text_elements['mark'] = Array(false,false,false,0,0,true,'*','*',false,false,false);
...
$html2text_elements['a'] = Array(false,false,false,1,1,false,'html2text_before_link',"",true,false,false);
...
$html2text_elements['img'] = Array(false,false,true,0,0,false,'html2text_before_img','',true,false,false);
#$html2text_elements['img'] = Array(false,false,true,0,0,false,'','',true,false,false);
...
function html2text( $sourceStr, $isXML = false, $isfile = false ) {
    global $html2text_elements;
	#$sourceStr = webCompatibleString($sourceStr);
	//echo mb_detect_encoding($sourceStr);
	//$sourceStr = iconv('', 'utf-8//TRANSLIT//IGNORE', $sourceStr);
	//$sourceStr = iconv('UTF-8', 'ASCII//TRANSLIT//IGNORE', $sourceStr);
    ...
    if( $DOM->documentElement ) {
        ...
        return ($sourceStr);
        #return wordwrap($sourceStr,75,"\r");
    } else {
        return '';
    }
}
